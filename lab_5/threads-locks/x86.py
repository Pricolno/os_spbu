...
class cpu:
    ...
    def __init__(self, memory, memtrace, regtrace, cctrace, compute, verbose, printstats, headercount):
        ...
        self.regnums        = [self.REG_ZERO, self.REG_AX, self.REG_BX, self.REG_CX, self.REG_DX, self.REG_EX, self.REG_FX, self.REG_SP, self.REG_BP]
    ...
    def rdump(self):
        ...
        print('ex:', self.registers[self.REG_EX], end=' ')
        print('fx:', self.registers[self.REG_FX], end=' ')
        return
